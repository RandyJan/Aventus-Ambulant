    ...
    <div>
        <transition name="container">
            <div class="fixed inset-0 bg-gray-100 z-50">
                ...
                <!-- CONTENT -->
                <div v-if="main != null" class="h-full overflow-y-auto">
                    <div class="mx-auto mb-14 mt-5 p-5 pt-0 max-w-lg">
                        ...
                        >
                            <img
                                :src="payload.parent.img_path"
                                onerror="this.onerror=null;this.src='/assets/default-product.png';"
                                class="h-56 w-full object-cover pointer-events-none group-hover:opacity-75"
                                alt=""
                            />
                        </div>
                        <div class="flex justify-between mt-2">
                            <div
                                class="ml-1 text-base font-medium text-gray-500 truncate pointer-events-none"
                            >
                                {{ payload.parent.description }}
                            </div>
                            <span
                                class="flex items-center px-3 py-0.5 rounded-full text-sm font-medium bg-gray-600 text-gray-50"
                            >
                                {{ payload.parent.price.toFixed(2) }}
                            </span>
                        </div>
                        <div
                            class="flex space-x-5 justify-center items-center mt-5"
                        >
                            <button
                                @click="minusQty()"
                                type="button"
                            ...
                            <div class="text-4xl font-medium">
                                {{ main ? main.modified_quantity : 0 }}
                            </div>
                            <button
                                :disabled="!canDoPlusQty"
                                @click="plusQty()"
                                type="button"
                                :class="{
                                    'opacity-50': !canDoPlusQty,
                                }"
                                class="inline-flex items-center px-2 py-1 border border-gray-300 shadow-sm text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                            >
                                <svg
                        ...
                        <div
                            v-if="get_current_transaction.is_sc && main != null"
                            class="mt-5"
                        >
                            <div class="relative">
                                <div
                                ...
                                <div class="relative flex justify-center">
                                    <span
                                        class="px-2 bg-gray-100 text-sm text-gray-500 tracking-wide"
                                    >
                        ...
                        <div v-if="non_modifiable.length > 0" class="mt-5">
                            ...
                            <div class="p-2 text-gray-500">
                                <label
                                    v-for="(item, index) in non_modifiable"
                                    :key="index"
                        ...
                        <div v-if="modifiable.length > 0" class="mt-5">
                            ...
                            <!-- component -->
                            <div
                                v-for="(item, index) in modifiable"
                                :key="index"
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div class="grid grid-cols-12">
                                            <div
                                                class="col-span-3 flex justify-center items-center space-x-2"
                                            >
                                                <button
                                                    @click="
                                            ...
                                            <div
                                                class="col-span-7 text-xs items-center"
                                            >
                                                <div>
                                                    {{
                                            ...
                                            <div
                                                class="col-span-2 text-xs font-semibold flex justify-end items-center"
                                            >
                                                {{
                                                    (
                        ...
                        <div class="mt-4 border-t">
                            <div class="">
                                <div v-if="vatable_sales > 0" class="relative">
                                    ...
                                    >
                                        <span
                                            class="pr-3 bg-gray-100 text-sm font-medium text-gray-700"
                                        >
                                            VATable Sales
                                        </span>
                                        <span
                                            class="pr-3 pl-2 bg-gray-100 text-sm font-medium text-gray-700"
                                        >
                            ...
                            <!-- :class="{
                                'bg-green-600 hover:bg-green-700 focus:ring-green-500': quantity > 0,
                                'bg-red-600 hover:bg-red-700 focus:ring-red-500': quantity <= 0
                            }" -->
                            <button
                                v-if="main.modified_quantity > 0"
                                @click="submit()"
                                type="button"
                                class="bg-green-600 hover:bg-green-700 focus:ring-green-500 mt-4 w-full justify-center inline-flex items-center px-4 py-3 border border-transparent text-sm leading-4 font-semibold rounded-md shadow-sm text-white focus:outline-none focus:ring-2 focus:ring-offset-2 tracking-wide"
                            >
                                Save Changes - {{ net_amount.toFixed(2) }}
                            </button>
                            <button
                                v-if="main.modified_quantity <= 0"
                                @click="remove()"
                                type="button"
                                class="bg-red-600 hover:bg-red-700 focus:ring-red-500 mt-4 w-full justify-center inline-flex items-center px-4 py-3 border border-transparent text-sm leading-4 font-semibold rounded-md shadow-sm text-white focus:outline-none focus:ring-2 focus:ring-offset-2 tracking-wide"
                            >
                                Remove
                            </button>
                        </div>
...
export default {
    ...
    methods: {
        ...
        fetchComponents() {
            axios
                .get(`/postmixes`, {
                    params: {
                        display_only: true,
                        product_id: this.payload.parent.product_id,
                        limit: 100,
                    },
                })
                .then((res) => {
                ...
                axios
                    .get("/outlet-products", {
                        params: {
                            ...
                            branch_id: this.payload.parent.branch_id,
                            outlet_id: this.payload.parent.outlet_id,
                            // group: el.group_code,
        ...
        updateComponents(action) {
            this.non_modifiable.forEach((el) => {
                el.modified_quantity = el.child_quantity * this.quantity;
            });
        ...
        submit() {
            ...
            confirm
                .fire({
                    text: "This action will update the item.",
        ...
        remove() {
                ...
                swal.fire({
                    ...
                    preConfirm: () => {
                        ...
                        axios
                            .delete(`/cart-item`, {
                                data: {
                                    os_number: this.payload.parent.os_number,
                                    product_id: this.payload.parent.product_id,
                                    sequence: this.payload.parent.sequence,
                                    supervisor: this.supervisor,
                                },
                            })
                            .then((res) => {
            ...
            confirm
                .fire({
                    text: "This action will completely remove the item.",
                    // confirmButtonText: 'Proceed to update Table number.',
                })
                .then((result) => {
                    if (result.isConfirmed) {
        ...
        populateItems() {
            this.non_modifiable.forEach((el) => {
                this.payload.items.forEach((payloadEl) => {
                    if (
                        payloadEl.product_id !=
                        payloadEl.main_product_component_id
                    ) {
                        return;
                    }
                    if (el.child_product_id == payloadEl.product_id) {
                        el.modified_quantity = payloadEl.quantity;
                    }
                });
            });
            ...
            this.modifiable.forEach((el) => {
                ...
                el.group_products.forEach((e) => {
                    this.payload.items.forEach((payloadEl) => {
                        ...
                        if (e.product_id == payloadEl.product_id) {
                            e.modified_quantity = payloadEl.quantity;
                        }
                    });
                });
            });
        ...
        //     // end
        // },
        getMainProductRecord() {
            axios
                .get(`/outlet-products/${this.payload.parent.product_id}`, {
                    branch_id: this.payload.parent.branch_id,
                    outlet_id: this.payload.parent.outlet_id,
                })
                .then((res) => {
                    this.main = {
                        ...JSON.parse(JSON.stringify(this.payload.parent)),
                        ...JSON.parse(
                            JSON.stringify(this.tax_and_discount_template)
                        ),
                        ...JSON.parse(JSON.stringify(res.data.data)),
                        amount: 0,
                        net_amount: 0,
                        modified_quantity: this.payload.parent.quantity,
                        retail_price: this.payload.parent.price,
                    };
                    this.compute_tax_and_discount(this.main);
                });
        },
    ...
    computed: {
        ...mapGetters(["get_current_transaction", "get_settings"]),
        canDoPlusQty() {
            if (this.get_settings.app_type == "restaurant_ambulant") {
                if (this.main.modified_quantity >= this.quantity) {
                    return false;
                }
            }
        ...
        total_amount() {
            ...
            totals += this.payload.parent.amount;
    ...
    created() {
        this.getMainProductRecord();
        this.quantity = this.payload.parent.quantity;
        ...
        this.sc_count = parseInt(this.payload.parent.sc_headcount);
    },
};
</script>
