<template>
    <div class="pb-4">
        ...
        <div class="mt-2 flex justify-between items-center">
            ...
            <div v-if="orderslips != null && orderslips.data.length > 0" class="flex items-center">
                ...
                <span class="relative z-0 inline-flex shadow-sm rounded-md">
                    <button @click="btnPrevious()" :class="{
                        'opacity-50 cursor-not-allowed':
                            orderslips.links.prev == null,
                    }" :disabled="orderslips.links.prev == null" type="button"
                    ...
                    <button @click="btnNext()" type="button" :class="{
                        'opacity-50 cursor-not-allowed':
        ...
        <!-- IF HAS RECORDS -->
        <div v-if="orderslips != null && orderslips.data.length > 0" class="mt-4">
            <ul role="list"
                class="grid grid-cols-2 gap-2 sm:gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
                <li v-for="(item, index) in orderslips.data" :key="index"
                    ...
                    <div class="w-full p-4 sm:px-8 md:px-6 text-gray-600">
                        ...
                        <div class="mt-6">
                            ...
                            <button v-if="
                                get_auth.user.username ==
                                item.user_current_transaction
                            " @click="detachCurrentTransaction(item)" type="button"
                            ...
                            " class="flex items-center mt-1">
                                ...
                                <div class="text-sm truncate ml-2">
                                    ...
                                    {{
                                        item.accounttype == 1 ? "Private" : "Corporate"
                            ...
                            <!-- NICK NAME -->
                            <div v-if="get_settings.app_type == 'shell_ambulant'" class="flex items-center mt-1">
                    ...
                    <div>
                        <div class="-mt-px flex divide-x divide-gray-200">
                            <div v-if="
                                get_auth.user.username !=
                                item.user_current_transaction
                            " @click="attachCurrentTransaction(item)" class="w-0 flex-1 flex">
                                <a href="javascript:;"
                            ...
                            <div v-if="
                                ...
                                item.user_current_transaction &&
                                item.is_paid == true
                            " @click="markAsCompleteTheOrderslip(item)" class="w-0 flex-1 flex">
                                <a href="javascript:;"
                                    class="relative -mr-px w-0 flex-1 inline-flex items-center justify-center py-4 text-sm text-gray-700 font-medium border border-transparent rounded-bl-lg hover:text-gray-500">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="text-gray-400 h-5 w-5" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div v-if="orderslips != null && orderslips.data.length > 0" class="flex justify-between items-center mt-4">
            <div>
            ...
            <div class="flex items-center">
                ...
                <!-- This example requires Tailwind CSS v2.0+ -->
                <span class="relative z-0 inline-flex shadow-sm rounded-md">
                    <button @click="btnPrevious()" type="button" :class="{
                        'opacity-50 cursor-not-allowed':
                            orderslips.links.prev == null,
        ...
        <!-- IF NO RECORDS -->
        <div v-if="orderslips != null && orderslips.data.length == 0" class="mt-10 text-center">
